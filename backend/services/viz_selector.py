...
def select_visualization(
    ...
    # Case 1: Datetime + Numeric → Line chart
    if datetime_cols and numeric_cols:
        return {
            "chart_type": "line",
            "x_axis": datetime_cols[0],
            "y_axis": y_axis,
            "reason": f"Datetime column '{datetime_cols[0]}' vs numeric '{y_axis}'",
        }

    # Case 2: Categorical + Numeric → Bar or Pie chart
    ...
    # Case 3: Two numeric columns → Bar chart
    ...
    # Case 4: Single column (distribution)
